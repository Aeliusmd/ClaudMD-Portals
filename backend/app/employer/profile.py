...
from app.auth.user_profile_type import UserType, is_employer_admin, user_type_label
...
def fetch_profile_from_clinic(clinic, current_user: CurrentUser) -> EmployerProfile:
    ...
    with get_clinic_connection(clinic) as conn:
        ...
        user_group_id = None
        if user_row.UserGroupId is not None:
            try:
    ...
    return EmployerProfile(
        ...
        is_admin=is_employer_admin(user_group_id),
    )
