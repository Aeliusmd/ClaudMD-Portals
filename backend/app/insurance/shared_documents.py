"""Resolve secure shared-document links for insurance recipients.

Access: SharedDocuments recipient (Email / ShareWithUserId) AND visit under
the logged-in user's insurance company (CheckInsHeader.InsuranceId).
"""
...
def _load_shared_document_access(
    current_user: CurrentUser,
    shared_id: str,
) -> tuple[Any, InsuranceProfile, dict[str, Any]]:
