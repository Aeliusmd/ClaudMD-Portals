...
function mapEmployeeSearchRow(row) {
  ...
  return {
    ...
    reportType: row.report_type || row.visit_type || null,
    visitType: row.visit_type || row.report_type || null,
    ...
    incidents: [
      {
        ...
        visitType: row.visitType || row.reportType || null,
        reportType: row.reportType || row.visitType || row.category || "Visit",
          ...
          ? [
              {
                ...
                label: row.visitType || row.reportType || row.category || "Visit",
                category: row.category,
                documents: [],
              },
            ]
